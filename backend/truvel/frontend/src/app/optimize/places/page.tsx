...
export default function PlacesPage() {
  ...
  >([
    { name: "서울타워", address: "서울특별시 용산구 남산공원길 105", image: "/icons/blank.png" },
    { name: "명동", address: "서울특별시 중구 명동", image: "/icons/blank.png" },
    { name: "홍대입구", address: "서울특별시 마포구 홍대로", image: "/icons/blank.png" }
  ]);
