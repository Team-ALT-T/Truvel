...
public interface CityRepository extends JpaRepository<City, Long> {
    ...
    List<City> findByKoreanContainingIgnoreCase(String keyword, Pageable pageable);

    // City 엔티티 자체의 영어 이름으로 검색
    List<City> findByEnglishContainingIgnoreCase(String keyword);
    List<City> findByEnglishContainingIgnoreCase(String keyword, Pageable pageable);
    ...
    List<City> findByCountryIdAndKoreanContainingIgnoreCase(Long countryId, String keyword, Pageable pageable);
    List<City> findByCountryIdAndEnglishContainingIgnoreCase(Long countryId, String keyword);
    List<City> findByCountryIdAndEnglishContainingIgnoreCase(Long countryId, String keyword, Pageable pageable);

    // 특정 CountryId에 속하는 모든 도시 조회
    List<City> findByCountryId(Long countryId);
    List<City> findByCountryId(Long countryId, Pageable pageable);
